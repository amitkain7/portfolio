  ...
  return (
    <div id='hero' className='flex items-center ml-4 mt-6  gap-4 md:justify-around md:ml-0'>
      <div className='p-4'>
        ...
        <a className='py-1 rounded-xl w-full bg-purple-500 text-white mt-6 hover:scale-105 transition block text-center ' href="https://drive.google.com/file/d/14O-ajPJdiNxXWugJlZg2gXldf5kyfsJU/view?usp=drive_link">Resume</a>
      </div>
